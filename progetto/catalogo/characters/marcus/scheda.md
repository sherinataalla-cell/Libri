...
famiglia: characters
sottotipo: minori
tipo_grafo: character
ruolo_saga: Antagonista del passato — uomo di fiducia di Dante, tradì vendendo informazioni che costarono la vita a tre uomini; Dante lo distrusse psicologicamente fino al suicidio. Mentore e amante di Adrian Bell (il Cacciatore). Figura che genera tutta la catena di vendetta.
status: provvisorio
ultima_modifica: 2026-06-05
fonti:
  - "story_graph.json#entities.characters.marcus"
appare_in_storie: []
relazioni: {}
---
